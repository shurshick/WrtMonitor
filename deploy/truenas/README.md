...
Актуальная тестовая версия: `v0.1.0-test.12`.
...
1. Скачайте из релиза `wrtmonitor-truenas-v0.1.0-test.12.yaml`.
...
Сервер `v0.1.0-test.12` не запустится с `change-me-*` секретами. Это нормально и сделано специально.
