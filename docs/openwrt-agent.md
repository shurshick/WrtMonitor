...
```sh
wget -O wrtmonitor-openwrt-agent-v0.1.0-test.12.tar.gz \
  https://github.com/shurshick/wrtmonitor/releases/download/v0.1.0-test.12/wrtmonitor-openwrt-agent-v0.1.0-test.12.tar.gz
```

Распакуйте архив:

```sh
tar -xzf wrtmonitor-openwrt-agent-v0.1.0-test.12.tar.gz
```
