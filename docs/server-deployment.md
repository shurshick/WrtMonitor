...
Этот документ описывает установку сервера `wrtmonitor` для тестовой версии `0.1.0-test.3`.
...
1. Откройте релиз:
   [v0.1.0-test.3](https://github.com/shurshick/wrtmonitor/releases/tag/v0.1.0-test.3)

2. Скачайте файл:

   ```text
   wrtmonitor-truenas-0.1.0-test.3.yaml
   ```
